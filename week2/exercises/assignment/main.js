...
const questions = [
    ...
    { question: 'The only nation in the world whose name in English ends in H, it\'s also one of the 10 most populous.', answer: 'What is Bangladesh?', numberOfGames: '40', player: 'Amy Schneider' },
